...
function lineChart () { // <-1A
    ...
    _chart.render = function () { // <-2A
        if (!_svg) {
            _svg = d3.select("#linebar3d").append("svg") // <-2B
                .attr("height", _height)
                .attr("width", _width);
...
const Paged3linebar = (props) => {
    ...
    const init = () => {
        ...
        for (var i = 0; i < numberOfSeries; ++i){
            dataCal.push(d3.range(numberOfDataPoint).map(function (i) {
    ...
    return (
        <>
            <div className="linebar3d" id='linebar3d' style={{ height: '350px', width: '100%' }}>
                <BoxBtn3 text="更换数据" upBtn={upBtn}></BoxBtn3>
